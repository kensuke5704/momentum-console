...
SRC=ROOT/'data/research/sec-marketwide-nq-inventory-through-h2-2007.json'
SHARD_INDEX=int(os.environ.get('SHARD_INDEX','0'));SHARD_COUNT=int(os.environ.get('SHARD_COUNT','1'))
OUT=ROOT/f'data/research/sec-etf-registrant-operational-prefilter-through-h2-2007-shard-{SHARD_INDEX:02d}.json'
CUTOFF='2007-12-31'
...
def load(ciks):
 ...
 for y,qs in ((2005,range(1,5)),(2006,range(1,5)),(2007,range(1,5))):
  for q in qs:
