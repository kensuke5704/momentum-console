...
INV=ROOT/'data/research/sec-complete-portfolio-inventory-through-h2-2007.json'
PREF=ROOT/'data/research/sec-etf-registrant-operational-prefilter-through-h2-2007.json'
MANDATORY='2006-02-06'; ASOF='2007-12-31'
...
base=load('catalog_base',ROOT/'scripts/research-sec-id-era-strict-series-source-base-through-h2-2007.py')
...
def prospectus_set(rows):
    ...
    # Preserve frozen semantics: retain latest public supplement at each calendar month-end.
    for year,months in ((2005,range(1,13)),(2006,range(1,13)),(2007,range(1,13))):
        for month in months:
            import calendar
