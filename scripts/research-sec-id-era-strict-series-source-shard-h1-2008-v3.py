...
INV=ROOT/'data/research/sec-complete-portfolio-inventory-through-h1-2008.json'
PREF=ROOT/'data/research/sec-etf-registrant-operational-prefilter-through-h1-2008.json'
MANDATORY='2006-02-06'; ASOF='2008-06-30'
...
base=load('catalog_base',ROOT/'scripts/research-sec-id-era-strict-series-source-base-through-h1-2008.py')
...
def prospectus_set(rows):
    ...
    for year,months in ((2005,range(1,13)),(2006,range(1,13)),(2007,range(1,13)),(2008,range(1,7))):
        for month in months:
            import calendar
