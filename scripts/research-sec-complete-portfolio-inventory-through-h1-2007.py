...
OUT = ROOT / "data" / "research" / "sec-complete-portfolio-inventory-through-h1-2007.json"
UA = {
...
QUARTERS = [(2006, 1), (2006, 2), (2006, 3), (2006, 4), (2007, 1), (2007, 2)]
...
def main() -> None:
    ...
    out = {
        "purpose": "Production-independent cumulative complete-portfolio filing inventory through the last H1 2007 signal date from official SEC quarterly master indexes. Includes N-Q/N-Q-A and certified annual/semiannual shareholder-report forms N-CSR/N-CSRS plus amendments from 2006 Q1 through 2007 Q2 filed by 2007-06-29. No known ETF source accessions, holdings outcomes, ranks, returns, or strategy results are used.",
