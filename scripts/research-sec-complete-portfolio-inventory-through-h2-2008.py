...
OUT = ROOT / 'data' / 'research' / 'sec-complete-portfolio-inventory-through-h2-2008.json'
UA = {
...
def main() -> None:
    ...
    out = {
        'purpose': (
            'Production-independent cumulative complete-portfolio filing inventory through the last H2 2008 signal date '
            'from official SEC quarterly master indexes. Includes N-Q/N-Q-A and certified annual/semiannual shareholder-report '
            'forms N-CSR/N-CSRS plus amendments from 2006 Q1 through 2008 Q4 filed by 2008-12-31. No known ETF source '
