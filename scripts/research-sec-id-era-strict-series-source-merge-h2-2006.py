...
IN_DIR=ROOT/'data/research/id-era-strict-h2-shards'
OUT=ROOT/'data/research/sec-id-era-strict-series-source-h2-2006.json'
MONTHS=[('2006-07','2006-07-31'),('2006-08','2006-08-31'),('2006-09','2006-09-29'),('2006-10','2006-10-31'),('2006-11','2006-11-30'),('2006-12','2006-12-29')]

def main():
    paths=sorted(IN_DIR.glob('sec-id-era-strict-series-source-h2-2006-shard-*.json'))
