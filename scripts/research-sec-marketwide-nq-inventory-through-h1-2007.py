...
OUT = ROOT / 'data/research/sec-marketwide-nq-inventory-through-h1-2007.json'
UA = {
...
def main():
    ...
    out = {
        'purpose': (
            'Production-independent cumulative SEC source inventory through the last H1 2007 signal date. '
            'All official SEC master-index N-Q/N-Q-A filings from 2006 Q1 through 2007 Q2 filed by 2007-06-29 are listed. '
            'Jan-Jun 2007 monthly snapshots are defined mechanically by filingDate <= the fixed signal date. No known '
