...
OUT = ROOT / 'data' / 'research' / 'sec-complete-portfolio-inventory-through-h2-2007.json'
UA = {
...
QUARTERS = [(2006, 1), (2006, 2), (2006, 3), (2006, 4), (2007, 1), (2007, 2), (2007, 3), (2007, 4)]
...
def main() -> None:
    ...
    for year, quarter in QUARTERS:
        ...
        print('QUARTER', json.dumps({'year': year, 'quarter': quarter, 'acceptedRows': len(rows), 'candidateForms': dict(sorted(forms.items())), 'transport': transport}), flush=True)
    ...
    out = {
        'purpose': 'Production-independent cumulative complete-portfolio filing inventory through the last 2007 signal date from official SEC quarterly master indexes. Includes N-Q/N-Q-A and certified annual/semiannual shareholder-report forms N-CSR/N-CSRS plus amendments from 2006 Q1 through 2007 Q4 filed by 2007-12-31. No known ETF source accessions, holdings outcomes, ranks, returns, or strategy results are used.',
        'years': [2006, 2007], 'quarters': [f'{y}Q{q}' for y, q in QUARTERS], 'cutoff': CUTOFF, 'acceptedForms': sorted(ACCEPTED_FORMS),
