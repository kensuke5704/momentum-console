...
OUT = ROOT / 'data/research/sec-marketwide-nq-inventory-through-h1-2008.json'
UA = {
...
def main():
    ...
    out = {
        'purpose': (
            'Production-independent cumulative SEC source inventory through the last H1 2008 signal date. '
            'All official SEC master-index N-Q/N-Q-A filings from 2006 Q1 through 2008 Q2 filed by 2008-06-30 are listed. '
            'Jan-Jun 2008 monthly snapshots are defined mechanically by filingDate <= the fixed signal date. No known '
