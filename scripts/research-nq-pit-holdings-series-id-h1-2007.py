...
SOURCE = DIR / 'sec-id-era-strict-series-source-h1-2007.json'
ADAPTED = DIR / 'sec-id-era-strict-series-source-h1-2007-holdings-adapter.json'
OUT = DIR / 'nq-pit-holdings-series-id-h1-2007.json'
...
def adapt_source_catalog(source: dict, source_artifact_id: int) -> dict:
    ...
    return {
        'purpose': 'Mechanical Series-ID-only schema adapter for the validated H1 2007 strict source catalog. No source is added, removed, renamed, bridged, or inferred.',
...
def main() -> None:
    ...
    result['purpose'] = (
        'H1 2007 Series-ID source-catalog-driven raw complete-portfolio holdings extraction. '
    ...
    print('H1_2007_HOLDINGS_SUMMARY', json.dumps({
        'sourceCatalogArtifactId': source_artifact_id,
