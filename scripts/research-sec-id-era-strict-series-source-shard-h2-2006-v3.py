...
INV=ROOT/'data/research/sec-complete-portfolio-inventory-through-h2-2006.json'
PREF=ROOT/'data/research/sec-etf-registrant-operational-prefilter-through-h2-2006.json'
MANDATORY='2006-02-06'; ASOF='2006-12-29'
...
base=load('catalog_base',ROOT/'scripts/research-sec-id-era-strict-series-source-base-through-h2-2006.py')
...
def prospectus_set(rows):
    ...
    for year,months in ((2005,range(1,13)),(2006,range(1,13))):
        for month in months:
            import calendar
