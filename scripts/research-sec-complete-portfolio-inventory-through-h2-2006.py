...
OUT = ROOT / "data" / "research" / "sec-complete-portfolio-inventory-through-h2-2006.json"
UA = {
...
def main() -> None:
    ...
    out = {
        "purpose": "Production-independent cumulative complete-portfolio filing inventory through the last H2 2006 signal date from official SEC quarterly master indexes. Includes N-Q/N-Q-A and certified annual/semiannual shareholder-report forms N-CSR/N-CSRS plus amendments from 2006 Q1-Q4 filed by 2006-12-29. No known ETF source accessions, holdings outcomes, ranks, returns, or strategy results are used.",
        "year": 2006, "quarters": [1, 2, 3, 4], "cutoff": CUTOFF, "acceptedForms": sorted(ACCEPTED_FORMS),
