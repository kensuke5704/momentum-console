...
const NEXT_ACTIONS: Array<{ type: NextActionType; label: string; meaning: string; detail: string }> = [
  { type: "BUY_NEXT_OPEN", label: "BUY", meaning: "Next open", detail: "次の米国営業日の寄付きでTop2を新規購入します。" },
  { type: "SELL_ALL_NEXT_OPEN", label: "EXIT", meaning: "Next open", detail: "次の米国営業日の寄付きで全保有銘柄を売却します。" },
  { type: "HOLD", label: "HOLD", meaning: "Keep", detail: "現在のポートフォリオをそのまま維持します。" },
  { type: "CASH_RECOVERY", label: "LOCK", meaning: "Recovery", detail: "現金のまま、設定されたRecovery連続日数を満たすまで待機します。" },
  { type: "MONTH_END_REBALANCE_NEXT_OPEN", label: "REBAL", meaning: "Month-end", detail: "月末シグナル確定後、次の米国営業日の寄付きでTop2へリバランスします。" },
  { type: "CASH", label: "CASH", meaning: "No order", detail: "保留中の注文はなく、現金で待機します。" },
];
